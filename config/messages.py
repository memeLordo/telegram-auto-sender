...
class Reply:
    ...
    FORM_OLD = [
        (
            "Кстати, вы можете пока заполнить форму, которая пойдёт непос"
            "редственно директору для ознакомления.Вот ссылка на неё:\n"
            "https://docs.google.com/forms/d/e/1FAIpQLScQ4MXsn-Qrl38tRwgB"
            "6O5LPXrGt2Wasv8H5hCvA-N5H4w2Hw/viewform\n"
            'После этого отпишитесь, например "+", и мы продолжим диалог.\n'
        ),
        (
            "Кстати, вы можете пока заполнить форму, которая пойдёт непос"
            "редственно директору для ознакомления.\nВот ссылка на неё:\n"
            "https://docs.google.com/forms/d/e/1FAIpQLScQ4MXsn-Qrl38tRwgB"
            "6O5LPXrGt2Wasv8H5hCvA-N5H4w2Hw/viewform\n"
            'После этого отпишитесь, например "+", и мы продолжим диалог.\n'
        ),
