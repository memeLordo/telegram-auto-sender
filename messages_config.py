...
ad_3_FreeAssist = (
    ...
    '\n'
    'Stonks - эксперты в сегменте криптотестнетов, объединившиеся с uCrypto'
    ' для создания фонда, позволяющего инвесторам зайти в нишу тестнетов'
    'с помощью опыта и команды из более чем 25 человек.'
